          ...
          <div className="p-8">
            ...
            <div className="border-t-2 border-gray-200 pt-6">
              ...
              <div className="space-y-3 mb-4">
                ...
                {selectedNearbyPlaces.length > 0 && (
                  <div className="flex justify-between text-gray-700">
                    ...
                    <span className="font-semibold">{formatPrice(totalNearbyPlacesCost * totalPeople)}</span>
                  </div>
                )}
                {totalAccommodationCost > 0 && (
                  <div className="flex justify-between text-gray-700">
                    <span>Accommodation (3 nights)</span>
                    <span className="font-semibold">{formatPrice(totalAccommodationCost)}</span>
                  </div>
                )}
              </div>
              <div className="border-t-2 border-gray-300 pt-4 flex justify-between items-center">
                ...
                <span className="text-4xl font-bold text-indigo-600">{formatPrice(grandTotal)}</span>
              </div>
              {grandTotal <= budget && (
                <div className="mt-4 bg-green-100 border-2 border-green-300 rounded-xl p-4 flex items-center">
                  ...
                  <span className="text-green-800 font-semibold">
                    Great! Your trip is within budget ({formatPrice(budget - grandTotal)} under budget)
                  </span>
                </div>
              )}
              {grandTotal > budget && (
                <div className="mt-4 bg-yellow-100 border-2 border-yellow-300 rounded-xl p-4 flex items-center">
                  ...
                  <span className="text-yellow-800 font-semibold">
                    Note: Trip exceeds budget by {formatPrice(grandTotal - budget)}
                  </span>
                </div>
              )}
            </div>
